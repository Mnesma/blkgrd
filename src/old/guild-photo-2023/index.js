...
const playerButtonTemplate =
    document.querySelector("#player-button-template").children[0];
...
const [mainParticleContainer, poutletParticlesContainer] = document
    .querySelectorAll(".particles-container");
...
const setUltraButtonStyle = (style) => {
    ...
    switch (style) {
        case UltraButtonStyle.SirUltra: {
            ultraButton.style.setProperty(
                "background-image",
                "url(assets/guild-photo-2023/sirultra_button.png)"
            );
        ...
        case UltraButtonStyle.Ultra: {
            ultraButton.style.setProperty(
                "background-image",
                "url(assets/guild-photo-2023/ultra_button.png)"
            );
...
const playParticles = () => {
    particlesJS.load(
        "niolet-particles-container",
        "particles/niolet-particles.json"
    );
    particlesJS.load(
        "poglet-particles-container",
        "particles/poglet-particles.json"
    );
    particlesJS.load(
        "gunlet-particles-container",
        "particles/gunlet-particles.json"
    );
    particlesJS.load(
        "heartlet-particles-container",
        "particles/heartlet-particles.json"
    );
    particlesJS.load(
        "starelet-particles-container",
        "particles/starelet-particles.json"
    );
    particlesJS.load(
        "maplelet-particles-container",
        "particles/maplelet-particles.json"
    );
    particlesJS.load(
        "sittingcomfortable-particles-container",
        "particles/sittingcomfortable-particles.json"
    );
    particlesJS.load(
        "bedgelet-particles-container",
        "particles/bedgelet-particles.json"
    );
    particlesJS.load(
        "brainlet-particles-container",
        "particles/brainlet-particles.json"
    );
    particlesJS.load(
        "hehelet-particles-container",
        "particles/hehelet-particles.json"
    );
    particlesJS.load(
        "hmmlet-particles-container",
        "particles/hmmlet-particles.json"
    );
    particlesJS.load(
        "meeselet-particles-container",
        "particles/meeselet-particles.json"
    );
    particlesJS.load(
        "niolets-particles-container",
        "particles/niolets-particles.json"
    );
    particlesJS.load(
        "sciencelet-particles-container",
        "particles/sciencelet-particles.json"
    );
    particlesJS.load(
        "poutlet-particles-container",
        "particles/poutlet-particles.json"
    );
...
const selectPlayerInDirection = (direction) => {
    ...
    const nextIndex = Math.min(
        Math.max(currentPlayerIndex + direction, 0),
...
const startApp = () => {
    ...
    imageRequests
        ...
        .then((playerNames) => {
            playerNames.forEach((playerName) => {
                ...
                newButton.style.setProperty(
                    "background-image",
                    `url("assets/guild-photo-2023/${playerName}_button.png")`
                );
        ...
        .then(() => {
            ...
            playerButtonContainer.addEventListener(
                "wheel",
                scrollInWheelDirection
            );
