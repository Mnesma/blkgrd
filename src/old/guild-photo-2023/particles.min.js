    ...
    a && Object.deepExtend(i, a),
        ...
        i.fn.retinaInit = function() {
            i.retina_detect && window.devicePixelRatio > 1
                ...
                i.particles.size.value = i.tmp.obj.size_value
                    * i.canvas.pxratio,
                i.particles.size.anim.speed = i.tmp.obj.size_anim_speed
                    * i.canvas.pxratio,
                i.particles.move.speed = i.tmp.obj.move_speed
                    * i.canvas.pxratio,
            ...
            if (
                    ...
                    if (c >= 0 && "mousemove" == i.interactivity.status) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                var v = i.interactivity.modes.bubble.opacity
                                    * c;
                                v > e.opacity
                ...
                if (i.tmp.bubble_clicking) {
                    var s = e.x - i.interactivity.mouse.click_pos_x,
                        ...
                        r = Math.sqrt(s * s + n * n),
                        p = ((new Date()).getTime()
                            - i.interactivity.mouse.click_time) / 1e3;
                    ...
                    if (
                        i.interactivity.mouse.click_pos_x =
                            ...
                            i.interactivity.mouse.click_pos_y =
                                i.interactivity.mouse.pos_y,
                            i.interactivity.mouse.click_time = (new Date())
                                .getTime(),
                            i.interactivity.events.onclick.enable
                    ) {
        ...
        i.fn.vendors.createSvgImg = function(e) {
            var a = i.tmp.source_svg,
                ...
                s = a.replace(t, function(a, t, i, s) {
                    ...
                    } else {var n = "hsla(" + e.color.hsl.h + ","
                            + e.color.hsl.s + "%," + e.color.hsl.l + "%,"
                            + e.opacity + ")";}
                    return n;
                }),
